...
class AnagramChecker:
    def __init__(self, words_list_file="sowpods.txt"):
        """load the word list file (text file) into a variable"""
        # we take the words as a set to avoid duplicates and remove "\n"
    ...
    def get_anagrams(self, word):
        ...
        if not self.is_valid_word(word):
            ...
            # return [w for w in self.words if w!= word and sorted(w) == sorted(word)].sort() # ?????
            return sorted([w for w in self.words if w != word and sorted(w) == sorted(word)])


# # validation check
# print(AnagramChecker("sowpods.txt").is_valid_word(
#     "Supercalifragilisticexpialidocious"))  # false
# print(AnagramChecker("sowpods.txt").is_valid_word("42"))  # false
# print(AnagramChecker("sowpods.txt").is_valid_word("meat"))  # true
# print(AnagramChecker("sowpods.txt").get_anagrams(
